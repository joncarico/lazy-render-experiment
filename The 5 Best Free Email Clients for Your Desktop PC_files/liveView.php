...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108507&subId=[MUO-Reg-Org-MOB]&x=SEKXLEN&y=SEKYLEN&cbuster=1672767087',
					origQString: 's=108507&subId=[MUO-Reg-Org-MOB]',
					placementId: 108507,
					x: 728,
					y: 410,
					videoType: 'flow',
